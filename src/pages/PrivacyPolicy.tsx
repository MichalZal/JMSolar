  ...
  return (
    <>
      ...
      <main className="pp-page">
        <div className="pp-page__header">
          <div className="section__tag">Dokumenty</div>
        ...
        <div className="pp-content">
          ...
          <ol>
            <li>
              ...
              adresem url: <strong>fotowoltaika.jmsolar.pl</strong>
            </li>
            <li>
              Operatorem serwisu oraz Administratorem danych osobowych jest:
              Jakub Czujwid Bytom Odrzański, ul. Marii Konopnickiej 6a
            </li>
            <li>
              Adres kontaktowy poczty elektronicznej operatora: biuro@jmsolar.pl
            </li>
            <li>
          ...
          <ol>
            ...
            <li>
              ...
              obsługi zgłoszenia serwisowego lub kontaktu handlowego, rejestracji
              usług itp. Każdorazowo kontekst i opis formularza w czytelny sposób
          ...
          <ol>
            <li>
              ...
              ciasteczek w urządzeniu końcowym użytkownika. W zakresie informacji
              o preferencjach użytkownika gromadzonych przez sieć reklamową
              Google użytkownik może przeglądać i edytować informacje wynikające
